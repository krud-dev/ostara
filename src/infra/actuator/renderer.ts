...
export const actuatorBridge: ActuatorBridge = {
  ...
  endpoints: (url: string) => ipcRenderer.invoke('actuator:endpoints', url),
  ...
  envProperty: (url: string, name: string) => ipcRenderer.invoke('actuator:envProperty', url, name),
  ...
  logger: (url: string, name: string) => ipcRenderer.invoke('actuator:logger', url, name),
  updateLogger: (url: string, name: string, level: string) =>
    ipcRenderer.invoke('actuator:updateLogger', url, name, level),
  clearLogger: (url: string, name: string) => ipcRenderer.invoke('actuator:clearLogger', url, name),
};
