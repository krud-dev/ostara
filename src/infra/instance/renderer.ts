...
export const instanceServiceBridge: InstanceServiceBridge = {
  ...
  setInstanceLoggerLevel: (instanceId: string, loggerName: string, level: ActuatorLogLevel | undefined) =>
  ...
  setApplicationLoggerLevel: (applicationId: string, loggerName: string, level: ActuatorLogLevel | undefined) =>
