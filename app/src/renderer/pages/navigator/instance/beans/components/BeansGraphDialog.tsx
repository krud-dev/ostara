...
import GraphComponent from 'renderer/pages/general/graph/components/GraphComponent';
import { Edge, Node } from 'reactflow';
import { chain, uniqBy } from 'lodash';
import { getIncomingNodes, getOutgoingNodes } from 'renderer/pages/general/graph/utils/reactFlowUtils';
...
const BeansGraphDialog: FunctionComponent<BeansGraphDialogProps> = NiceModal.create(({ bean, allBeans }) => {
  ...
  const connectedNodes = useMemo<Node[]>(
    () =>
      uniqBy([...getIncomingNodes(bean.name, nodes, edges), ...getOutgoingNodes(bean.name, nodes, edges)], (n) => n.id),
    [bean, nodes, edges]
  );
