export default {
  ...
  instanceAliasUnknown: 'Instance "{alias}" status is unknown',
  ...
  checkSystemConfiguration: 'Please check the system configuration',
  ...
  appUpdateGeneralError: 'There was an error while reaching the update server.',
  ...
  dirty: 'Dirty',
  totalCommitCount: 'Total Commit Count',
  ...
  createBackupExplanation:
    'Backups are generated by the system automatically in regular intervals. You can also generate manual backups by clicking the "Backup Now" button next to the search bar. Backups are stored locally and can be restored by clicking the "Restore" button next to desired backup.',
  ...
  testConnectionToAgentSuccess: 'Connection to agent was successful',
  testConnectionToAgentFailed: 'Connection to agent failed',
  cannotConnectToAgent: 'Cannot connect to agent',
  errorLoadingSources: 'Error loading sources',
  loadingAgentSources: 'Loading agent sources...',
  noAgentSources: 'No agent sources',
  agentSources: 'Agent Sources',
  agentNamePending: 'Agent "{name}" is loading',
  ...
  invalidAgentAuthentication: 'Invalid agent authentication',
  ...
  notificationTitleAgentHealthy: '{agent} is HEALTHY',
  notificationBodyAgentHealthy: 'Service discovery is active.',
  notificationTitleAgentUnhealthy: '{agent} is UNHEALTHY',
  notificationBodyAgentUnhealthy: 'Service discovery is not active.',
};
