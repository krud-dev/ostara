...
class FolderController(
    ...
    fun moveFolder(@PathVariable folderId: UUID, @RequestParam(required = false) newParentFolderId: UUID? = null, @RequestParam(required = false) newSort: Double? = null): FolderRO {
