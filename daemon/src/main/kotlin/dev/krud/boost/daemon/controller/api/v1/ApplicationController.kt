...
) : AbstractCrudController<Application, ApplicationRO, ApplicationModifyRequestDTO, ApplicationModifyRequestDTO>(Application::class, ApplicationRO::class, crudHandler)