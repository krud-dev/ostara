...
class ApiController {
  ...
  fun updateOrder(@PathVariable id: Long, @RequestBody order: Order): Order {
    return order
  }
  ...
  fun updateInvoice(@PathVariable id: Long, @RequestBody invoice: Invoice): Invoice {
    return invoice
  }
  ...
  fun updatePayment(@PathVariable id: Long, @RequestBody payment: Payment): Payment {
    return payment
  }
  ...
  fun createShipment(@RequestBody shipment: Shipment): Shipment {
    return shipment
  }
